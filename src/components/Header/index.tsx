...
const Header = () => {
  ...
  return (
    ...
    >
      <div className='max-w-[1170px] md:h-0 h-auto md:invisible visible mx-auto px-4 sm:px-7.5 md:px-0'>
        {/* <!-- header top start --> */}
        <div
          className={`flex flex-col lg:flex-row gap-5  items-end lg:items-center md:justify-between ease-out duration-200 ${
        ...
        >
          ...
          <div className='flex w-full lg:w-auto items-center gap-7.5'>
            ...
            <span className='hidden md:block w-px h-7.5 bg-gray-4'></span>
                ...
                <li className='py-4'>
                  <Link href='/signin' className='flex items-center gap-2.5'>
                    ...
                    <div>
                      ...
                      <p className='font-medium text-custom-sm text-dark pr-4'>
                        Iniciar Sesión
                      </p>
                    </div>
                  </Link>
